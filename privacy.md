...
No Tracking or Cookies
    Our website is built to be a “zero-cookie” environment. We do not use:
        Cookies: We do not place small files on your device to track your behavior. See 3. for an exclusion where WordPress uses cookies for sessions.
        Tracking Pixels: We do not use invisible images to monitor your activity.
        Analytics: We do not use third-party analytics services (like Google Analytics) that store user data.
        Strictly Necessary Cookies – These cookies are essential for WordPress to function properly and provide a seamless browsing experience. They are typically session cookies, meaning they are deleted when you close your browser. 
